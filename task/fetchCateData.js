...
function fetchSinglePage(task,callback){
	...
	var jsonData ={"category":cate,"sort":"topSelling","size":"30","page":pageNum,"text":"","within":"","query":"allCategories:9:divCode:1","condition":{"disp1DepthCategoryCode":cate,"brand":[],"gender":[],"priceRange":[0,3851.3],"skinType":[],"productionType":[],"spfIndex":[],"age":[],"flavorType":[],"hairType":[],"specialPriceYnOption":false,"giftYnOption":false,"isNewProductOption":false,"fastShopYnOption":false,"flatPriceYnOption":false}}
...
let pageTotal = 15      //将要爬取的总页数
let fetchNum = 0        //当前并发数
let products = []       //商品数据



const  fetchCateData = function(){
    let taskArray = []
